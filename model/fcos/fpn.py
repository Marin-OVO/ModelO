...
class IntermediateLayerGetter(nn.ModuleDict):
    """
        ...
        Arguments:
            model (nn.Module): model on which we will extract the x
    ...
    """
        ...
        Arguments:
            ...
            extra_blocks (ExtraFPNBlock or None): if provided, extra operations will
                be performed. It is expected to take the fpn x, the original
                x and the names of the original x as input, and returns
...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.fpn = FeaturePyramidNetwork(
            ...
            extra_blocks=extra_blocks, # last level max pool
        )
